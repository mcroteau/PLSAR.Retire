<style>
    ...
    #query-lover{color:#000;background:#d1d7df;border:solid 1px #c0c7d0;}
    #query-lover::placeholder{color:#000;}
    textarea{border-bottom:dashed 1px #d9dde3;background: #fff;}
    ...
    #paper-editor{height:450px;}
    #paper-editor::placeholder{color:#d1d7df;}
</style>
