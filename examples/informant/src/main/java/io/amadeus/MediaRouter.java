...
import io.amadeus.assets.BlockService;
import io.amadeus.model.MediaPartial;
import io.amadeus.model.ResponseRange;
...
public class MediaRouter {
    ...
    @Post("/upload")
    public String upload(HttpRequest req, HttpResponse resp){
