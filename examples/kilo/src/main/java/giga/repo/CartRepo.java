...
public class CartRepo {
    ...
    public Cart getActive(String sessionId, Long businessId) {
        ...
        Cart cart = (Cart) dao.get(sql, new Object[] { sessionId, businessId}, Cart.class);
        return cart;
    }
    ...
    public List<Cart> getList(){
        ...
        List<Cart> carts = (ArrayList) dao.getList(sql, new Object[]{}, Cart.class);
        return carts;
    }

    public List<Cart> getList(long id){
        String sql = "select * from carts where business_id = [+] order by id desc";
        List<Cart> carts = (ArrayList) dao.getList(sql, new Object[]{ id }, Cart.class);
        return carts;
    }
    ...
    public List<CartItem> getListItems(Long id) {
        ...
        List<CartItem> cartItems = (ArrayList) dao.getList(sql, new Object[]{ id }, CartItem.class);
        return cartItems;
    }
    ...
    public CartItem getItem(Long id) {
        ...
        CartItem cartItem = (CartItem) dao.get(sql, new Object[] { id }, CartItem.class);
        return cartItem;
    }

    public CartItem getItem(Long itemId, Long cartId) {
        String sql = "select * from cart_items where item_id = [+] and cart_id = [+]";
        CartItem cartItem = (CartItem) dao.get(sql, new Object[] { itemId, cartId }, CartItem.class);
        return cartItem;
    }

    public ShipmentRate getRate(Long cartId) {
        String sql = "select * from shipment_rates where cart_id = [+]";
        ShipmentRate shipmentRate = (ShipmentRate) dao.get(sql, new Object[] { cartId }, ShipmentRate.class);
        return shipmentRate;
    }
    ...
    public List<CartOption> getOptions(Long id) {
        ...
        List<CartOption> cartOptions = (ArrayList) dao.getList(sql, new Object[]{ id }, CartOption.class);
        return cartOptions;
    }

    public Long getTotal(Long id) {
        String sql = "select count(*) from carts where business_id = [+]";
        Long count = (Long) dao.getLong(sql, new Object[] { id });
        return count;
    }
