...
<%--            <ocean:if spec="${business.allowAffiliates}">--%>
<%--                <ocean:set var="allow" value="selected"/>--%>
<%--                <ocean:set var="disallow" value=""/>--%>
<%--            </ocean:if>--%>

<%--            <ocean:if spec="${!business.allowAffiliates}">--%>
<%--                <ocean:set var="allow" value=""/>--%>
<%--                <ocean:set var="disallow" value="selected"/>--%>
<%--            </ocean:if>--%>
...
<%--    <br class="clear"/>--%>
    ...
    <div id="flat-rate-select-wrapper" style="float:left;width:346px;">
        ...
        <select name="flatShipping" id="flat-shipping" style="width:340px;">
            ...
            <ocean:if spec="${business.flatShipping}">
                <ocean:set var="flat" value="selected"/>
                <ocean:set var="realtime" value=""/>
            </ocean:if>

            <ocean:if spec="${!business.flatShipping}">
                <ocean:set var="flat" value=""/>
                <ocean:set var="realtime" value="selected"/>
            </ocean:if>
