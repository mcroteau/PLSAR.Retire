...
<ocean:if spec="${itemOptions.size() > 0}">
    ...
    <ocean:each var="itemOption" items="${itemOptions}" varStatus="idx">
...
<%--                    <input type="text" name="quantity"/>--%>
            ...
            <ocean:if spec="${itemOption.optionValues.size() == 0}">
...
<%--                        <th>Quantity</th>--%>
                    ...
                    <ocean:each items="${itemOption.optionValues}" var="optionValue">
                        <tr>
